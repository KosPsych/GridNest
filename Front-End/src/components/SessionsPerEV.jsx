...
class SessionsPerEV extends Component {
    state = { 
      ...
      async componentDidMount(){
        ...
        const {data: Sessions}= await axios.get("https://localhost:8765/evcharge/api/SessionsPerEV/"+this.props.match.params.VehicleID+"/"+this.props.match.params.datefrom+"/"+this.props.match.params.dateto);
