...
module.exports = function(object){
    ...
    if( checkParams('SessionsPerStation',object.station,object.datefrom,object.dateto,object.format,object.apikey) ){
        console.log(chalk.red('Error! Please enter correct parameters:'));
        console.log(chalk.green('Mandatory Parameters:'));
        console.log(chalk.green('--station             ex: 0001'));
        ...
        if (object.apikey!= fs.readFileSync('./Tokens/softeng20bAPI', {encoding:'utf8', flag:'r'}) )
            ...
            //Create url
            let baseUrl = createURL('SessionsPerStation/',object.station,object.datefrom,object.dateto,object.format,object.apikey);
