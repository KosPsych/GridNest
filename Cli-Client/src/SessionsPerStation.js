...
module.exports = function(object){
    ...
    //if(1==0) {}
        ...
        //Create url
        let baseUrl = createURL('/SessionsPerStation',object.station,object.datefrom,object.dateto,object.format,object.token);
        //const baseUrl = 'https://localhost:8765/evcharge/api/SessionsPerStation/0001/20181009/20181016?format=csv'
